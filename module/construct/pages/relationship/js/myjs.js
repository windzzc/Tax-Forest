    ...
    $(document).ready(function(){
        ...
        $.ajax({
            ...
            error:function(XMLHttpRequest, textStatus, errorThrown){
                ...
                if(XMLHttpRequest['responseJSON']['code']==177){
                layer.alert(XMLHttpRequest['responseJSON']['msg']);  
                }
                else if(XMLHttpRequest['responseJSON']['code']==212){
                layer.alert(XMLHttpRequest['responseJSON']['msg']);  
                }else{
                     layer.alert("认知关系挖掘失败");  
                }  
      ...
      if(dep == null){
        ...
        for(var i=0;i<edges.length;i++){
            $("#table").append(
              "<tr class='tr1 animated bounceInRight' id="+i+"><td>"+edges[i].sourceName+
              "</td><td><center><span class='glyphicon glyphicon-arrow-right  btn-lg'></span></center></td><td>"
              +edges[i].targetName+
              "</td><td><i class='glyphicon glyphicon-trash trash ' a="+edges[i].sourceName+
              " b="+edges[i].targetName+"></td></tr>"
            );
            console.log(i);
        }
