...
function DisplayBranch(dataset){
    ...
    length_firstfact = dataset["children"].length;
    ...
    var tree = buildBranch(dataset, seed, temp_scale);
    draw_tree(tree, seed, svg, temp_scale);
        /*****************************************************/
    //对分面树进行缩放
